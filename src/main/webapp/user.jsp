...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        <div class="layui-logo">
            <a href=""><img src="img/likelogo.png" style="width: 127px;height: 50px" alt="logo"></a>
        </div>
        <!-- 头部区域（可配合layui已有的水平导航） -->
        <ul class="layui-nav layui-layout-left">
            <li class="layui-nav-item"><a href="">首页</a></li>
            <li class="layui-nav-item"><a href="allProductinfoServlet">热销</a></li>
        ...
        <ul
            ...
            <li class="layui-nav cls"><input class="layui-input" type="text" name="sousuo" placeholder="输入看看有没有你中意的"></li>
        </ul>
        <ul class="layui-nav layui-layout-right">
            <li class="layui-nav-item">
                <a href="javascript:;">${uname.realname}</a>
                <dl class="layui-nav-child">
                    <dd><a href="userinfo.jsp">个人信息</a></dd>
                    <dd><a href="">查看订单</a></dd>
                    <dd><a href="http://localhost:8080/like">退出登陆</a></dd>
                </dl>
            </li>
            <li class="layui-nav-item"><a href="usershoppingcar.jsp" target="content">购物车<span class="layui-badge-dot"></span></a></li>
        </ul>
    </div>
